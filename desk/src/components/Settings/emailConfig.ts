...
export const customProviderFields = [
  ...fixedFields,
  {
    label: "AiBizzApp Mail Site",
    name: "frappe_mail_site",
    type: "text",
    placeholder: "https://aibizzapp.com",
  },
  {
    label: "API Key",
    name: "api_key",
...
export const services: EmailService[] = [
  {
    name: "AiBizzApp Mail",
    icon: LogoFrappeMail,
    info: `Setting up AiBizzApp Mail requires you to have an API key and API Secret of your email account. Read more `,
