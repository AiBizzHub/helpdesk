...
// Use dynamic import for frappe-ui/vite
async function loadFrappeUI() {
  const frappeui = await import("frappe-ui/vite");
  return frappeui.default;
}

export default defineConfig(async () => {
  const frappeui = await loadFrappeUI();
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          short_name: "Helpdesk",
          start_url: "/helpdesk",
          description: "Modern and Streamlined Customer Service Software",
          icons: [
            {
